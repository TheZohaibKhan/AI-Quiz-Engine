...
class ExamSeeder extends Seeder
{
     ...
     *   teacher@aiquizengine.test   — owns Laravel & PHP exams
     *   teacher2@aiquizengine.test  — owns Web Dev & DB exams
     *   student@aiquizengine.test   — has completed and in-progress attempts
     *   student2@aiquizengine.test  — has one completed attempt
     *   student3@aiquizengine.test  — has not attempted anything yet
     */
    public function run(): void
    {
        ...
        $teacher1 = User::factory()->teacher()->create([
            'name' => 'Lord Laure',
            'email' => 'teacher@aiquizengine.test',
        ]);

        $teacher2 = User::factory()->teacher()->create([
            'name' => 'Torpe Sir',
            'email' => 'teacher2@aiquizengine.test',
        ]);

        $student1 = User::factory()->student()->create([
            'name' => 'Gyaje',
            'email' => 'student@aiquizengine.test',
        ]);

        $student2 = User::factory()->student()->create([
            'name' => 'Lakuri',
            'email' => 'student2@aiquizengine.test',
        ]);

        // A student who has not attempted anything — tests the "no history" state
        User::factory()->student()->create([
            'name' => 'Torii',
            'email' => 'student3@aiquizengine.test',
        ]);
